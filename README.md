...
[![My Skills](https://skillicons.dev/icons?i=ts,js,python,rust,cs,java,html,react,django,fastapi,tailwind,css,sass,bootstrap,mysql,postgresql,mongodb,sqlite,postman,linux,kali,ubuntu,aftereffects,blender,figma,git,photoshop,premiere,unity,scikitlearn)](https://skillicons.dev)
